...
module.exports = {
  ...
  devtool: process.env.NODE_ENV === 'development' ? 'cheap-module-eval-source-map' : 'cheap-module-eval-source-map', // enhance debugging by adding meta info for the browser devtools
